...
public class StandardSelectorWrapper implements StandardSelector, InitializingBean {
	...
	private StandardSelector mSource;
	
	public StandardSelectorWrapper() {
		this(InnerBeanFactory.createStandardSelector());
	}
	
	public StandardSelectorWrapper(StandardSelector source) {
		mSource = source;
	}
	
	public final StandardSelector getSource() {
		return mSource;
	}
