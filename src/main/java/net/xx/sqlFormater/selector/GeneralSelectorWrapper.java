...
public class GeneralSelectorWrapper implements GeneralSelector, InitializingBean {
	...
	private GeneralSelector mSource;
	
	public GeneralSelectorWrapper() {
		this(InnerBeanFactory.createGeneralSelector());
	}
	
	public GeneralSelectorWrapper(GeneralSelector source) {
		mSource = source;
	}
	
	public final GeneralSelector getSource() {
		return mSource;
	}
